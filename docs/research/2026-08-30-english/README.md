# 2026-08-30 — 두 모드 중심과 영어 UI

## 문제·개선 요구

당시 제품을 타임어택·엔드리스 중심으로 정리하는 방향으로 바뀌었다.

## 무엇을 왜 수정했는가

스토리 진입을 메뉴에서 제외하고 UI 문구를 영어로 통일했으며 종료 축하 표현을 도입했다.

## 수정 후 변화

메뉴의 모드 수와 언어가 바뀌었다. 스토리 코드는 제거하지 않았다.

## 전후 모바일 화면

| 이전 35f096d | 이후 794a5f0 |
|---|---|
