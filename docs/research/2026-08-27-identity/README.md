# 2026-08-27 — TAP to TEN과 극장 디자인

## 문제·개선 요구

고정된 숫자 구성과 점수·잔여 숫자의 관계를 검토하고 시각 정체성을 정리했다.

## 무엇을 왜 수정했는가

9×9 숫자 덱과 10/20/40/80 점수 곡선, 벨벳·황동 중심 극장 디자인을 도입했다.

## 수정 후 변화

MAKEZERO에서 TAP to TEN으로 바뀌고 게임판과 배경·점수 표현이 달라졌다.

## 전후 모바일 화면

| 이전 38f51c0 | 이후 f018fc0 |
|---|---|
