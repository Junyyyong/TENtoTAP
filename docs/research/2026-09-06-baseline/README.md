...
현재 게임 소스는 `6542a95`다. 이번 문서는 2026-09-06에 Git 이력·현재 코드·작업 대화를 근거로 작성한 **사후 개발 정리**다. 아래 과거 날짜는 Git 작성 날짜(KST)이며 당시 작성한 실험 일지가 아니다. 이번 스크린샷은 모두 현재 버전 재현 화면으로, 과거 변경 전 사진이 아니다.
...
- 모바일 Chromium 에뮬레이션, 390×844 CSS px, DPR 4. 실제 휴대폰/Safari 검증이나 참가자 행동 관찰 자료가 아니다.
